...
#[Route(path: "/api/routers-settings", name: "routers_settings")]
class RouterSettingsController extends AbstractFOSRestController
{
  ...
  // #[Rest\Get('/ip/pools', name: 'ip_pool_list')]
  // #[QueryParam(name: 'routerUuid', strict: false, nullable: true, allowBlank: true, description: 'Rputer Uuid')]
